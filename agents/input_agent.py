...
def input_agent(state: State):
  ...
  result = input_parser.invoke([
    ...
    Example input: "Annie is in Midtown NYC and likes cheap Thai and Indian food. Bob is in East Village and likes Thai and Japanese food. Charlie is in Soho, NYC and likes cheap Mexican food. "
    
    Example output:
    - Members: [{"name": "Annie", "location": "Midtown NYC", "diet": "none"}, {"name": "Bob", "location": "East Village", "diet": "none"}, {"name": "Charlie", "location": "Soho, NYC", "diet": "none"}]
